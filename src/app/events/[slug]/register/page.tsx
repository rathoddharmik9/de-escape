        ...
        <div className="max-w-[680px] mx-auto">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              ...
              <input type="text" placeholder="Priya Sharma" value={form.full_name} onChange={(e) => set("full_name", e.target.value)} className={inputClass("full_name")} />
              {errors.full_name && <p data-field-error className="mt-1.5 text-xs text-[var(--error)]">{errors.full_name}</p>}
            </div>
